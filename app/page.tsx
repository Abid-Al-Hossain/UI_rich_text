...
export default function Page() {
  const [state, setState] = useState<RichTextState>(DEFAULT_RICHTEXT_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Rich Text Studio" controls={controls} preview={output} /></AppShell>;
}
